    ...
    >
      ...
      <div className="d-flex align-items-center gap-3 ms-5 me-5">
        ...
        <div className="position-relative category-menu">
          ...
          {isCategoryOpen && (
            <div
              className="position-absolute bg-dark text-white rounded shadow"
              style={{ top: "30px", left: "0", minWidth: "200px", zIndex: 1000 }}
            >
              {categorias.length === 0 ? (
        ...
        <div className="position-relative user-menu">
          ...
          {isUserOpen && (
            <div
              className="position-absolute bg-dark text-white rounded shadow"
              style={{ top: "40px", right: "0", width: "170px", zIndex: 1000, padding: "10px" }}
            >
